...
const tokenl = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Ijc5ZWQwYjU2LWNhNGMtNGM2ZC1hNzk4LTU4M2MxZjllMThkNSIsImlhdCI6MTc1NjE0MTI5NSwiZXhwIjoxNzU2MTQ4NDk1fQ.l_fzOMeEKzsdrbMSjwra4BOjMwwm8y5xODKFG5Wylfw'
class SocketService {
  ...
  private storedToken: string | null = tokenl || null;
  ...
  connect(token?: string): void {
    if (!this.socket) {
      this.storedToken = token || tokenl || null;
