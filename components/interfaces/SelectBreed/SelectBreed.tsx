...
const UpdateSelect =({label,refElement,information,numBtn,formName,breed}:{numBtn:number,label :string,refElement : React.RefObject<HTMLSelectElement | null>,information: string,formName:string,breed:breedPet[]})=>{
