    ...
    return (
            ...
            <div className='container_newObject'>
                ...
                <form action="" className='container_newObject_form' onSubmit={createEntrance}>
                      <InputForm
                      nameLabel='Nombre de quien autoriza'
                        placeHolder='Nombre'
                    ...
                    />
                      <InputForm
                        nameLabel='Apellido de quien autoriza'
                    ...
                    />
                     <InputForm
                        nameLabel={register ? 'Objeto a ingresar' : 'Objeto a salir'}
                    ...
                    />
                    <InputForm
                        imgIcon={register?'/assets/svg/sign-in-bold.svg': '/assets/svg/sign-out-bold.svg'}
                        typeInput= 'date'
                        nameOnsubmit= {'fecha'}
